...
class es extends en_gb
{
    ...
    protected function _LoadStrings()
    {
		...
		$strings['InsufficientPermissionsError'] = 'No tienes permiso para acceder a esta aula';
		$strings['MissingReservationResourceError'] = 'No se ha seleccionado un aula';
		...
		$strings['AllResources'] = 'Todas las aulas';
		...
		$strings['ResourceCapacity'] = 'Este aula tiene una capacidad de %s personas';
		$strings['ResourceCapacityNone'] = 'Este aula tiene capacidad ilimitada';
		$strings['AddNewResource'] = 'Agregar nuevo aula';
		$strings['AddNewUser'] = 'Agregar nuevo usuario';
		$strings['AddUser'] = 'Agregar usuario';
		$strings['Schedule'] = 'Planificación';
		$strings['AddResource'] = 'Agregar aula';
		...
		$strings['ResourcePermissions'] = 'Permisos del aula';
		...
		$strings['ResourceList'] = 'Aulas a reservar';
		...
		$strings['ReservationRequiresApproval'] = 'Una o más de las aulas reservadas requieren aprobación antes de su uso. Esta reserva queará pendiente hasta que sea aprobada.';
		...
		$strings['MoreResources'] = 'Más aulas';
		...
		$strings['AddResources'] = 'Agregar aulas';
		...
		$strings['AllResourcesOn'] = 'Todas las aulas habilitados';
		...
		$strings['DeleteGroupWarning'] = 'Al borrar este grupo se eliminarán todos los permisos de las aulas asociadas.  Los usuarios en este grupo pueden perder acceso a las aulas.';
		...
		$strings['DeleteResourceWarning'] = 'Al borrar esta aula se eliminarán todos los datos asociados, incluyendo';
		...
		$strings['AddUser'] = 'Agregar usuario';
		$strings['UserPermissionInfo'] = 'El acceso real a las aulas puede ser diferente dependiendo de los roles del usuario, permisos de grupo, o ajustes externos de permisos';
		...
		$strings['MoveResourcesAndReservations'] = 'Mover aulas y reservas a';
		...
		$strings['NoResourceAdministratorLabel'] = '(No hay administrador de aula)';
		$strings['WhoCanManageThisResource'] = '¿Quién puede administrar esta aula?';
		$strings['ResourceAdministrator'] = 'Administrador de aula';
		...
		$strings['ReservedResources'] = 'Aula reservada';
		$strings['ReservedAccessories'] = 'Accesorio reservado';
		$strings['ResourceUsageTimeBooked'] = 'Uso de aula - tiempo reservado';
		$strings['ResourceUsageReservationCount'] = 'Uso de aula - número de reservas';
		...
		$strings['ResourceFilter'] = 'Filtro de aulas';
		$strings['ResourceGroups'] = 'Grupos de aulas';
		...
		$strings['ResourceGroupHelp1'] = 'Arrastra los grupos de aulas a organizar.';
		$strings['ResourceGroupHelp2'] = 'Haz clic con el botón derecho sobre el nombre de un grupo de aulas para acciones adicionales.';
		$strings['ResourceGroupHelp3'] = 'Arrastra las aulas para agregarlos a los grupos.';
		$strings['ResourceGroupWarning'] = 'Si usas los grupos de aulas, cada aula debe estar asignado al menos a un grupo. Las aulas no asignados no estarán disponibles para ser reservados.';
		$strings['ResourceType'] = 'Tipo de aula';
		$strings['AppliesTo'] = 'Aplica a';
		$strings['UniquePerInstance'] = 'Único por instancia';
		$strings['AddResourceType'] = 'Agregar tipo de aula';
		$strings['NoResourceTypeLabel'] = '(no está establecido el tipo de aula)';
		...
		$strings['ResourceStatus'] = 'Estado del aula';
		$strings['CurrentStatus'] = 'Estado actual';
		$strings['AllReservationResources'] = 'Todas las aulas de las reservas';
		$strings['File'] = 'Fichero';
		$strings['BulkResourceUpdate'] = 'Actualización masiva de aulas';
		...
		$strings['More'] = 'Más';
		$strings['ResourceAvailability'] = 'Disponibilidad del aula';
		...
		$strings['AllResourceTypes'] = 'Todos los tipos de aulas';
		$strings['AllResourceStatuses'] = 'Todos los estados de las aulas';
		...
		$strings['ResourceColor'] = 'Color del aula';
		...
		$strings['ResourceDisplayPrompt'] = 'Aula a mostrar';
		...
		$strings['UsersWithAccessToResources'] = 'Usuarios con acceso a aulas';
		...
		$strings['NoResourcePermission'] = 'No tienes permisos para acceder uno o más de las aulas requeridas';
		...
		$strings['AccessoryResourceRequiredErrorMessage'] = 'El accesorio %s solamente puede reservarse con las aulas %s';
		...
		$strings['AccessoryResourceAssociationErrorMessage'] = 'El accesorio \'%s\' no puede reservarse con las aulas solicitadas';
		$strings['NoResources'] = 'No has agregado ningún aula.';
		...
		$strings['MyCalendar'] = 'Mi calendario';
		$strings['ResourceCalendar'] = 'Calendario de aulas';
		...
		$strings['ResourceReservations'] = 'Reservas de aulas';
		...
		$strings['ManageResourceGroups'] = 'Grupos de aulas';
		$strings['ManageResourceTypes'] = 'Tipos de aulas';
		$strings['ManageResourceStatus'] = 'Estados de aulas';
