 ...
 */
$conf['settings']['app.title'] = 'Reserva de Aulas - FCA';	// application title
$conf['settings']['default.timezone'] = 'America/Argentina/Buenos_Aires';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'false';        	// if users can register themselves
$conf['settings']['admin.email'] = 'mfalemany@gmail.com';         // email address of admin user
$conf['settings']['admin.email.name'] = 'Administrador';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'http://despachofca.unne.local:8080/booked/Web';  		 	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'booked';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'BookedCabral';
$conf['settings']['database']['hostspec'] = '172.17.0.5';        // ip, dns or named pipe
 ...
 */
$conf['settings']['install.password'] = 'Instalador2018';
/**
 * Pages
 */
