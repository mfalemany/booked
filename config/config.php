...
$conf['settings']['app.title'] = 'Reserva de Aulas - FCA';
$conf['settings']['default.timezone'] = 'America/Argentina/Buenos_Aires';
$conf['settings']['allow.self.registration'] = 'false';
$conf['settings']['admin.email'] = 'mfalemany@gmail.com';
$conf['settings']['admin.email.name'] = 'Administrador';
$conf['settings']['default.page.size'] = '50';
$conf['settings']['enable.email'] = 'true';
$conf['settings']['default.language'] = 'es';
$conf['settings']['script.url'] = 'http://despachofca.unne.local:8080/booked/Web';
...
$conf['settings']['database']['hostspec'] = '172.17.0.5';
